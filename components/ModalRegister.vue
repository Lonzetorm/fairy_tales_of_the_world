<template>
  <div>
    <div id="authentication-modal" tabindex="-1" aria-hidden="true" class="bg-black bg-opacity-75 my-auto overflow-y-auto overflow-x-hidden fixed z-50 justify-center items-center w-full inset-0 max-h-full">
      <div class="relative p-4 w-full max-w-md max-h-full mt-2 m-auto">
        <!-- Modal content -->
...
async function postRegisterForm() {
  if (password.value === repeat_password.value) {
    ...
    errors.value.set(password, { 'message': 'Пароли не совпадают' })
  }
}
